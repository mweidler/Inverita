...
\includegraphic[0.75]{scenario-usbdrive.pdf}{Scenario USB drive}{ScenarioUSB}

\subsection{Backup on internet cloud drive}
\includegraphic[0.75]{scenario-clouddrive.pdf}{Scenario Cloud drive}{ScenarioCloud}

\subsection{Backup on network attached storage (NAS)}
\includegraphic[0.75]{scenario-nasdrive.pdf}{Scenario NAS drive}{ScenarioNAS}

\includegraphic{scenario-clouddrive-detailed.pdf}{Scenario Cloud drive detailed}{ScenarioCloudD}
